...
export const ProjectScalarWhereWithAggregatesInput = new GraphQLInputObjectType(
  {
    ...
    fields: () => ({
      ...
      customRanges: { type: JsonWithAggregatesFilter },
      createdAt: { type: DateTimeWithAggregatesFilter },
      updatedAt: { type: DateTimeWithAggregatesFilter },
    }),
  },
...
export const DeviceWhereInput = new GraphQLInputObjectType({
  ...
  fields: () => ({
    ...
    panelId: { type: IntNullableFilter },
...
export const DeviceScalarWhereWithAggregatesInput = new GraphQLInputObjectType({
  ...
  fields: () => ({
    ...
    panelId: { type: IntNullableWithAggregatesFilter },
...
export const JsonFilter = new GraphQLInputObjectType({
  name: 'JsonFilter',
  fields: () => ({
    equals: { type: GraphQLJSON },
    path: { type: new GraphQLList(new GraphQLNonNull(GraphQLString)) },
...
export const JsonWithAggregatesFilter = new GraphQLInputObjectType({
  ...
  fields: () => ({
    ...
    not: { type: GraphQLJSON },
    _count: { type: NestedIntFilter },
    _min: { type: NestedJsonFilter },
    _max: { type: NestedJsonFilter },
  }),
})
...
export const NestedJsonFilter = new GraphQLInputObjectType({
